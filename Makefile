# This Makefile is for the Set::Functional extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Set/Functional.pm]
#     AUTHOR => q[Aaron Cohen <aarondcohen@gmail.com>]
#     LICENSE => q[perl]
#     NAME => q[Set::Functional]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/Set/Functional.pm]
#     clean => { FILES=>q[Set-Functional-*] }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Set/Functional.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Set
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Set
...
TO_INST_PM = lib/Set/Functional.pm

PM_TO_BLIB = lib/Set/Functional.pm \
...
DISTNAME = Set-Functional
DISTVNAME = Set-Functional-0.01
...
manifypods : pure_all  \
	lib/Set/Functional.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Set/Functional.pm $(INST_MAN3DIR)/Set::Functional.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:                Set-Functional' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:             0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:            set operations for functional programming' >> META_new.yml
	$(NOECHO) $(ECHO) 'license:             perl' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:              ' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Aaron Cohen <aarondcohen@gmail.com>' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>set operations for functional programming</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Set/Functional.pm blib/lib/Set/Functional.pm 
